    	<noscript>
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url()?>index.php/admin/obat">Data Pendaftaran</a></li>
			</ul>
	<div class="row-fluid">
                ...
                <?php echo form_open_multipart('admin/pdf_data');?>
					<div class="box-header">
						<h2><i class="halflings-icon list"></i><span class="break"></span>Laporan Data Pasien Daftar</h2>
						<div class="box-icon">
